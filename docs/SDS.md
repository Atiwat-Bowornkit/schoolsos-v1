...
> Historical design reference. For the implemented MVP, `MASTERPROMPT`, `SCOPE.md`,
> `API_CONTRACT.md`, and `DECISIONS.md` override any conflicting field, workflow,
> runtime, AI, KV, authentication, or deployment detail in this document.
